      ...
      await axios
        ...
        .then((response) => {
          ...
          if (response.status === 200) {
            ...
            setPendingcount(response?.data?.customers);
            setRejectedCount(response?.data?.businessOwners); 
      ...
      <Col xl="3" sm="6">
        ...
        <CardBody>
          <div className="d-flex align-items-center justify-content-between">
            <div className="d-flex align-items-center gap-2">
              <img src={square} alt="" className="square_box" />
              <h6 className="mb-0">Subscribed providers</h6>
            </div>
          </div>
          <div className="d-flex justify-content-between mt-3">
      ...
      <Col xl="3" sm="6">
        ...
        <CardBody>
          <div className="d-flex align-items-center justify-content-between">
            <div className="d-flex align-items-center gap-2">
              <img src={square} alt="" className="square_box" />
              <h6 className="mb-0">Unsubscribed Providers</h6>
            </div>
          </div>
          <div className="d-flex justify-content-between mt-3">
