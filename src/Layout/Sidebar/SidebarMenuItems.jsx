            ...
            <li className="sidebar-list" key={i}>
              ...
              {menuItem.type === "link" ? (
                <Link
                  ...
                  // style={{ backgroundColor: menuItem.active ? "#2F6FED" : "" }}
                  >
                  <SvgIcon className="stroke-icon" iconId={`stroke-${menuItem.icon}`} />
                  <SvgIcon className="fill-icon" iconId={`fill-${menuItem.icon}`} />
                  <span style={{ color: menuItem.active ? "#2f6fed" : "" }}>{t(menuItem.title)}</span>
                  {menuItem.badge ? <label className={menuItem.badge}>{menuItem.badgetxt}</label> : ""}
                </Link>
                      ...
                      <li key={index}>
                        ...
                        {childrenItem.type === "link" ? (
                          <Link
                            ...
                            style={{ backgroundColor: childrenItem.active ? "transparent" : "", color: childrenItem.active ? "#2F6FED" : "" }}

                            onClick={() => toggletNavActive(childrenItem)}>
                            {/* {t(childrenItem.title)} */}
                            <span style={{ color: childrenItem.active ? '#2F6FED' : '' }}> {t(childrenItem.title)}</span>
